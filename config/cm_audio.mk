...
ALARM_PATH := vendor/bee/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/bee/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/bee/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/bee/prebuilt/common/media/audio/ui
